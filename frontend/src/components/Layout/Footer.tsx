    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              ...
              <li><a href="https://github.com/Lazy-Protocol/lazy" target="_blank" rel="noopener noreferrer">GitHub</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="footer-socials">
          ...
          <a href="https://github.com/Lazy-Protocol/lazy" className="social-link" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
            <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-bottom">
          ...
          <Link to="/security" className="footer-security">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
            </svg>
            Security first. Learn more →
          </Link>
        </div>
      </div>
    </footer>
